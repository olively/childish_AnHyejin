...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/blog-post.css">
	<style>
.bg-dark {
...
.pagination {
  ...
  <body>
   ...
   <li class="nav-item active"><a class="nav-link" href="#">Free
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h1 class="my-4">Free Talk
            <small>A free space for anyone to write.</small>
          </h1>
